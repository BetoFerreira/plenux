...
<html lang="pt-br">
    <head>
        ...
        <title>Caixa Eletrônico - Dia</title>
        <!-- Bootstrap 4 -->
      ...
      <div class="row">
       <div class="col-md-12 col-md-offset-2">
		...
		<form method="POST" action="">
			...
			<div class="col-md-4">
				<label>Dia:</label>
				<input type="text" name="dia" class="form-control" placeholder="Dia"><br />
			</div>
			<div class="col-md-4">
				<label>Mês:</label>
  ...
  <table class="table table-bordered table-hover table-dark">
   <thead>
      ...
      if (isset($_POST['pesquisar'])) {
        ...
        $mes = $_POST['mes'];
        $ano = $_POST['ano'];
        $data_operacao = $ano."-".$mes."-".$dia;
        echo "<h5 class='p-3 mb-2 bg-light text-dark text-center'>Pesquisando por Ano-Mês-Dia : <u>"
