  ...
  <table class="table table-bordered table-hover table-dark">
   <thead>
      ...
      if (isset($_POST['pesquisar'])) {
        $ano = $_POST['ano'];
        $data_operacao = $ano."-";
        echo "<h5 class='p-3 mb-2 bg-light text-dark text-center'>Pesquisando por Ano : <u>"
    ...
    <?php     
       ...
       ?> 
                        <tbody>
                          ...
                          <right>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<right><a class="btn btn-info" href="index.php" target="_self">
                          Ir para o Menu</a></right>
                     </table>
<?php
     } else { //pesquisar   
